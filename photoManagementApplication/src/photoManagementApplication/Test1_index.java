...
public class Test1_index {
    ...
    //////////////////             
		InvIndexPhotoManager manager1=new InvIndexPhotoManager();
                BST<LinkedList<Photo>>all_photos=manager1.getPhotos();
                 all_photos.inOrder2();
		...
		manager1.addPhoto(p8);
                System.out.print("all photos afetr adding 8 photos are:");           
                 ...
                 displayListOfPhoto( manager1.allPhotos);  
...
//		
         ...
         public static void test_2_album_InvIndex()
        {
...
//		Photo p1=new Photo("hedgehog.jpg", tags1);
    ...
    //////////////////
		...
		manager1.addPhoto(p8);	
                  ...
                  System.out.println("test index album");
